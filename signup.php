        ...
        <div id="log-title">
            <h2>SignUp</h2>
              ...
              <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="password" aria-describedby="emailHelp" placeholder="Your Password">
              </div>
              <div class="last form-group">
                  <label for="cpassword">Confirm Password</label>
                  <input type="password" class="form-control" name="cpassword" aria-describedby="emailHelp" placeholder="Confirm Your Password">
              </div>
